...
exports.book_create_get = function (req, res, next) {
    ...
    //Get all authors and genres, which we can use for adding to your book
    async.parallel({
...
exports.book_create_post = [
    ...
    (req, res, next) => {
        ...
        //Extract the validation errors from a requests
        const errors = validationResult(req);

        //Create a Bool object with escaped and trimmed data
        var book = new Book({
